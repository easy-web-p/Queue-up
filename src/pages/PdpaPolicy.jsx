        ...
        <div className="pdpa-page-content-card bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-3xl p-6 sm:p-10 shadow-sm leading-relaxed space-y-6">
          ...
          {activeTab === "privacy" && (
            <div className="pdpa-content-section">
              ...
              {/* Spelled out because the app performs exactly this, and a policy
                  that promised total erasure would be promising something the
                  system deliberately does not do. */}
              <h4 className="pdpa-sub-title">3.1 การลบบัญชีด้วยตนเอง — สิ่งที่ถูกลบและสิ่งที่ถูกเก็บไว้</h4>
              <p>
                ผู้ใช้สามารถลบบัญชีได้เองที่หน้าโปรไฟล์ &rarr; &ldquo;ลบข้อมูลบัญชีออกจากระบบ&rdquo;
                โดยต้องยืนยันตัวตนด้วยรหัสผ่าน (หรือเข้าสู่ระบบ Google อีกครั้ง) ก่อนทุกครั้ง
              </p>
              <ul>
                <li>
                  <strong>ลบถาวร:</strong> บัญชีเข้าสู่ระบบ (Firebase Authentication) โปรไฟล์ผู้ใช้
                  ข้อมูลการแพ้อาหารและบันทึกสุขภาพ การผูกบัญชีผู้ปกครอง–นักเรียน ข้อความแชท
                  รีวิว รายการโปรด ประวัติการใช้คูปอง และกระเป๋าเงินของบัญชีนั้น
                </li>
                <li>
                  <strong>เก็บไว้แบบไม่ระบุตัวตน:</strong> ประวัติคำสั่งซื้อ — ชื่อ เบอร์โทร อีเมล
                  และรหัสผู้ใช้จะถูกลบออกจากรายการ เหลือเพียงยอดเงิน ร้านค้า และวันที่
                  เนื่องจากร้านค้าและสถานศึกษาต้องใช้สรุปยอดขายและกระทบยอดการเงิน
                </li>
                <li>
                  <strong>เก็บไว้ตามภาระหน้าที่ทางกฎหมาย:</strong> บันทึกความปลอดภัย (Audit Logs)
                  รวมถึงบันทึกการเข้าถึงข้อมูลสุขภาพฉุกเฉิน และบันทึกรายการเงินในระบบ
                  ซึ่งกฎหมายกำหนดให้ต้องเก็บรักษาและอยู่นอกขอบเขตสิทธิขอให้ลบ
                </li>
              </ul>
              <p>
                ระบบจะ<strong>ไม่ลบบัญชี</strong>หากกระเป๋าเงินยังมียอดคงเหลือ
                ยังมีคำสั่งซื้อที่ร้านกำลังจัดเตรียม ยังมีคำขอเติมเงินค้างอยู่
                ยังเป็นเจ้าของร้านค้าที่เปิดขาย หรือเป็นผู้ดูแลระบบคนสุดท้าย
                โดยจะแจ้งเหตุผลให้ทราบเพื่อดำเนินการให้เรียบร้อยก่อน
              </p>
            </div>
          )}
