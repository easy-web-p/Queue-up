 ...
 */
export function getActiveMerchantCoupons(storeId = "store_canteen01") {
  try {
    ...
    // Default demo coupon ONLY for default demo canteen
    if (storeId === "store_canteen01") {
      return [
        {
 ...
 */
export function deployAICoupon(couponObj, storeId = "store_canteen01") {
 ...
 */
export function toggleCouponState(code, storeId = "store_canteen01") {
  try {
    const activeCoupons = getActiveMerchantCoupons(storeId);
