...
export default class ErrorBoundary extends React.Component {
  ...
  render() {
    if (this.state.hasError) {
      ...
      return (
        <div className="min-h-[60vh] flex items-center justify-center p-6 text-center bg-slate-950 text-slate-100 font-['Kanit']">
          <div className="max-w-md w-full bg-slate-900 border border-orange-500/30 rounded-3xl p-8 shadow-2xl space-y-4">
            <div className="w-14 h-14 mx-auto rounded-2xl bg-orange-500/20 text-orange-500 flex items-center justify-center text-2xl shadow-inner">
              ⚠️
            </div>
